...
class EventNotifier extends StateNotifier<List<Event>> {
  ...
  Future<String> fetchEvent(String query, BuildContext context) async {
    final token = await AuthService.getAccessToken();
    final String baseUrl =
        'https://school.amanilightequity.com/api/school-event/?search=$query';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        state = data.map((json) => Event.fromJson(json)).toList();
        return 'success';
      } else {
