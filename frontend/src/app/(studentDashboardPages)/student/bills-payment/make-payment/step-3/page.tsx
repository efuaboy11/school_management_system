              ...
              <div className="d-flex justify-content-center">
                <div>
                  ...
                  <div className="text-center">
                    ...
                    <p className="light-text">Your payment has been successfully recorded in our database. Our team will now verify the payment details. Once verification is complete and everything is in order, your bills status will be updated to <strong>Successful</strong>.</p>
                  ...
                  <div className="row justify-content-center mt-3">
                    <div className="col-lg-6 col-md-9 col-sm-10">
                      <Link href='/student/bills-payment/make-payment/step-1' className="site-btn width-100 Link">Make another payment</Link>
