                ...
                <div>
                  ...
                  <div className="row justify-content-center mt-3">
                    <div className="col-lg-6 col-md-9 col-sm-10">
                      <Link href='/bursary/school-fees-payment/add/step-1' className="site-btn width-100 Link">Make another payment</Link>
                      <div className="text-center mt-2">
                        <Link href='/bursary/home' className="light-link"><i className="ri-home-smile-line pe-1"></i>Home</Link>
                      </div>
